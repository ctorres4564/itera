  ...
  return (
    <div className="fixed inset-y-0 right-0 w-full sm:w-[32rem] bg-surface border-l border-border-default shadow-modal z-50 flex flex-col transform transition-transform duration-300 ease-out" role="dialog" aria-modal="true" aria-labelledby="deepdive-title">
      ...
      <div className="p-4 border-b border-border-default flex items-center justify-between bg-surface-muted">
        <h3 id="deepdive-title" className="font-bold text-brand-secondary flex items-center space-x-2">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        <div>
          <h4 className="text-xs font-bold text-brand-secondary uppercase tracking-wider mb-2">1. Origem Histórica</h4>
          <p className="text-sm text-text-secondary leading-relaxed">{deepDive.origin}</p>
        </div>

        {deepDive.terminal && (
          <div>
            <h4 className="text-xs font-bold text-brand-secondary uppercase tracking-wider mb-2">2. O Terminal</h4>
        ...
        {deepDive.stdout && (
          <div>
            <h4 className="text-xs font-bold text-brand-secondary uppercase tracking-wider mb-2">3. Saída Padrão (stdout)</h4>
            <p className="text-sm text-text-secondary leading-relaxed">{deepDive.stdout}</p>
          </div>
        )}

        <div>
          <h4 className="text-xs font-bold text-brand-secondary uppercase tracking-wider mb-2">4. Evolução da Linguagem</h4>
          <p className="text-sm text-text-secondary leading-relaxed">{deepDive.evolution}</p>
        </div>

        {deepDive.internalBehavior && (
          <div>
            <h4 className="text-xs font-bold text-brand-secondary uppercase tracking-wider mb-2">5. Funcionamento Interno</h4>
            <p className="text-sm text-text-secondary leading-relaxed">{deepDive.internalBehavior}</p>
          </div>
        )}

        <div>
          <h4 className="text-xs font-bold text-brand-secondary uppercase tracking-wider mb-2">6. Outras Linguagens</h4>
          <p className="text-sm text-text-secondary leading-relaxed">{deepDive.comparisons}</p>
        </div>

        <div>
          <h4 className="text-xs font-bold text-brand-secondary uppercase tracking-wider mb-2">7. Boas Práticas</h4>
          <p className="text-sm text-text-secondary leading-relaxed">{deepDive.goodPractices}</p>
        </div>

        <div>
          <h4 className="text-xs font-bold text-brand-secondary uppercase tracking-wider mb-2">8. Curiosidades</h4>
        ...
        {deepDive.conceptualChallenges.length > 0 && (
          <div className="pt-4 border-t border-border-default space-y-3">
            <h4 className="text-xs font-bold text-brand-secondary uppercase tracking-wider">
